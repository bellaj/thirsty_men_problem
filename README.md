...
- The cups should be put in a row (the first one is the head of the row and the last is the tail). We can assume that the pourer has marked the final position (first place, second,.. last), so each cup should be placed in one of these positions.
